...
#define STRING_CONFIG_H_AUTHOR "(EatMoTacos, Ender-3 Pro)" // Who made the changes.
...
#define MACHINE_UUID "c6700827-27bd-4661-801d-201f2417aad5"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Creality Ender-3 Pro
    ...
    #define DEFAULT_Kp_LIST {  21.14,  21.14 }
    #define DEFAULT_Ki_LIST {   1.76,   1.76 }
    #define DEFAULT_Kd_LIST {  63.54,  63.54 }
  #else
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Creality Ender-3 Pro
  #define DEFAULT_bedKp 106.81
  #define DEFAULT_bedKi 20.82
  #define DEFAULT_bedKd 365.34
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -40.3, -8.5, -1.13 }
